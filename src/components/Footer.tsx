...
export const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden w-full bg-black text-white">
      ...
      <div className="md:border-none border-t-[1px] bg-black text-white/70 text-center border-solid border-white/20 py-2 text-[12px]">
        Designed & Built by{" "}
        <a
          href="/"
