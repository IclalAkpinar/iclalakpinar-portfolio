...
export const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    description:
      "The corporate website developed for Kapsül Teknoloji Platformu features dual themes and bilingual support. I joined the project during its development phase and contributed by adding new pages, such as the blog section, while preserving the original structure. The design of the site uses animations to enhance the user experience, and a high-quality visual style was applied to create a modern corporate platform. My contributions focused on enriching the existing structure by adding more functionality, particularly by integrating new content areas. Additionally, I ensured the site’s responsive design, making sure it works seamlessly across all devices. This project resulted in a visually dynamic and professional web platform that effectively caters to Kapsül Teknoloji’s broad audience.",
